class App {
    public static void main(String[] args) {
      ...
      String email = "test@gmail.com";
        // System.out.println(email.contains("@gmail.net"));
        // System.out.println(email.isEmpty());
       boolean startsWithTest = email.startsWith("test");
       System.out.println(startsWithTest);
       boolean endsWithdotCom = email.endsWith(".com");
       System.out.println(endsWithdotCom);
    if(password.equals("1234") && email.equalsIgnoreCase("TEST@gmail.com")){
